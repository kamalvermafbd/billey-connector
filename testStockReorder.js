...
`;
        ...
        for (
            ...
            console.log(
                "Reorder Level:",
                stock.reorderLevel,
                typeof stock.reorderLevel
            );

            console.log(
                "Minimum Order Quantity:",
                stock.minimumOrderQuantity,
                typeof stock.minimumOrderQuantity
            );
            ...
            console.log(
                "Reorder Period Length:",
                stock.reorderPeriodLength,
                typeof stock.reorderPeriodLength
            );

            console.log(
                "Reorder Criteria:",
                stock.reorderCriteria
            );

            console.log(
                "Minimum Order Period:",
                stock.minimumOrderPeriod
            );

            console.log(
                "Minimum Order Period Length:",
                stock.minimumOrderPeriodLength,
                typeof stock.minimumOrderPeriodLength
            );

            console.log(
                "Minimum Order Criteria:",
                stock.minimumOrderCriteria
            );

            console.log(
                "Reorder As Higher:",
                stock.reorderAsHigher
            );

            console.log(
                "Minimum Order As Higher:",
                stock.minOrderAsHigher
            );
